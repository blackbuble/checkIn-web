 ...
 onSubmit = event => {
  ...
  render(){
    return (
        <div>
        {/* Begin page */}
        <div className="accountbg" style={{background: 'url("http://stars-h2020.eu/wp-content/uploads/2018/03/Photo-INEA-Project-Fiche.png")', backgroundSize: 'cover', backgroundPosition: 'center'}} />
